...
<body>
    ...
    <div class="card text-center" id="addDoc">
	  	...
	  	<div class="card-body">
                ...
                <table class="table" id="tabExerc">
                    ...
                    <?php }else for($cE=0;$cE<$entrou;$cE++){ ?>
						<tr class="table-active <?php echo 'filtro-'.$linhaExer[$cE]['nivel'].' filtro-'.$linhaExer[$cE]['aula']; ?>">				
					      	<td><img src="../<?php echo $linhaExer[$cE]['imgExerc'];?>" width="50"/></td>
	        ...
	        ?>
            <!-- Formulário de Audio-->
			<form method="POST" action="../../back/backCadDocument.php" id="formAudio">
                ...
                <div class="form-group row">
			    	...
			    	<div class="col-sm-9 input-group mb-3">
			    		<input type="text" class="form-control" id="cadNomeAudio" name="cadNomeAudio" placeholder="Exemplo: 'Sequencia-Acordes1'" maxlength="30" required>
			    		<div class="input-group-append">
                ...
                <div class="form-group row">
			    	...
			    	<div class="col-sm-9 input-group mb-3">
			    		<input type="text" class="form-control" id="cadComplemento" name="cadComplemento" placeholder="Exemplo: 'modalSequencia1'" maxlength="50" required>
			    		<div class="input-group-append">
			...
			<form method="POST" action="../../back/backCadDocument.php" id="formApp"> 
                ...
                <!-- Nome da Imagem -->
			  	<div class="form-group row"> 
			    	...
			    	<div class="col-sm-9 input-group mb-3">
				    		<input type="text" class="form-control" id="cadImgApp" name="cadImgApp" placeholder="Exemplo: 'cifra-club'" maxlength="30" required>
				    		<div class="input-group-append">
    							<span class="input-group-text">.png</span>
  							</div>
					</div>
                ...
                <table class="table" id="tabApp"> 
		  			...
		  			<tbody>
                        ...
                        $entrou=0;
		  				...
		  				?>
						<tr class="table-active">				
					      	<td><img src="../../img/app/<?php echo $linhaApp['img'].".png";?>" width="30"/></td>
                            <td><?php echo $linhaApp['nome'];?></td>
                            <td><?php echo $linhaApp['descricao'].".php";?></td>
